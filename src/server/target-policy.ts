...
import { loopbackAddress, publicAddress } from "./public-address";
...
/** Strict shared parser without the admission-only development exception. */
export function parsePublicTargetUrl(raw: string): URL {
  return parseTargetUrl(raw);
}
