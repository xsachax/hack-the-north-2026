...
| --- | --- | --- | --- |
| 00 | In progress | Pending | Existing foundation: 30 offline tests, production build, real Gateway smoke, completed remote session, desktop/mobile layout checks |
| 01 | Pending | Pending | Depends on 00 |
