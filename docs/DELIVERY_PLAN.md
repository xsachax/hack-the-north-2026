...
| 08 | In progress; release blocked | Issue #16, refs #1/#8 | Release hardening, private single-host packaging, complete offline CI, dedicated security review, capability audit and bounded rehearsal. Public-website acceptance remains blocked by the external provider/deployment decision in EXECUTION.md; this layer cannot close #1/#8 or declare overall release acceptance. |
